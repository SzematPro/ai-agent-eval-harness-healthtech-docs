...
[ficha del modelo](../reference/model-card.md).
...
|-------------|----------------------|----------------|
| GOV 1.1: Los requisitos legales y regulatorios se comprenden | Postura regulatoria documentada en la [postura regulatoria](../reference/regulatory-posture.md); frontera de bienestar/CDS de la FDA, orientación de la OMS 2024, GMLP de la MHRA, artículos de la Ley de IA de la UE mapeados | Limitada a marcos de EE. UU./UE/Reino Unido/Chile; un sistema en producción necesitaría revisión legal específica de la jurisdicción para cada región de despliegue |
...
| GOV 1.3: Los roles y responsabilidades para el riesgo de IA están definidos | Propiedad clara de los módulos: barreras de seguridad, arnés de evaluación, observabilidad (spans de OpenTelemetry según la [decisión de observabilidad](../adr/adr-0006-observability.md)) | No hay separación de funciones; el autor es desarrollador, revisor y operador |
...
| MAP 1.3: Se comprenden las restricciones y limitaciones | Limitaciones honestas documentadas: KB de un solo dominio con 36 tarjetas, corpus de evaluación de 218 casos, sesgo de vocabulario de inglés estadounidense, escalamiento ciego a la negación, durabilidad en memoria para la revisión con humano en el ciclo | Las limitaciones están documentadas; no hay un registro de riesgos formal con puntuación de severidad |
...
| MAP 2.1: Los componentes del sistema de IA están documentados | Registros de decisiones de arquitectura; la especificación del sistema; el grafo de seis nodos documentado en la [decisión de orquestación](../adr/adr-0001-orchestration.md); los Datos del Sistema de IA de la ficha del modelo | La documentación es exhaustiva para la implementación de referencia; un sistema en producción necesitaría runbooks operativos |
...
| MAP 2.3: Se identifican los riesgos de terceros | El Protocol del cliente LLM abstrae las dependencias de proveedores (véase la [decisión de abstracción de proveedores de LLM](../adr/adr-0002-llm-vendor-abstraction.md)); los proveedores se listan en la Información de Terceros de la ficha del modelo | No hay una evaluación formal de riesgos de terceros; no hay BAA ni revisión contractual con los proveedores de LLM |
...
| MEASURE 1.2: Se evalúa el rendimiento del sistema de IA | Compuerta determinista en CI (un cliente stub determinista sin clave, 218 casos); ejecución nocturna con modelo en vivo; red-team con Promptfoo | La compuerta determinista es reproducible; las métricas con modelo en vivo no están congeladas en la ficha del modelo (se reportan en los informes de evaluación) |
| MEASURE 1.3: Los datos de evaluación son representativos | 218 casos a través de 3 locales (en, es-419, pt-BR); 5 grupos de condiciones; categorías de referencia (golden) + adversarias + sin coincidencia | Muestra pequeña; no hay estratificación demográfica (no se recopilan datos demográficos); sesgo de inglés estadounidense reconocido |
...
| MEASURE 2.3: Existen mecanismos de monitoreo y retroalimentación | Evaluación en CI en cada cambio; red-team nocturno; spans de OpenTelemetry en cada nodo; sumideros de Langfuse Cloud y Phoenix (véase la [decisión de observabilidad](../adr/adr-0006-observability.md)) | El monitoreo cubre la implementación de referencia; no hay alertas de producción, monitoreo de SLA ni una canalización de detección de degradación |
...
| Subcategoría | Implementación actual | Evaluación de brechas |
|-------------|----------------------|----------------|
| MANAGE 1.1: Las decisiones de tratamiento del riesgo se documentan | Los registros de decisiones de arquitectura documentan las decisiones de diseño que afectan el riesgo (la [decisión de barreras de seguridad](../adr/adr-0005-guardrails.md), la [decisión de observabilidad](../adr/adr-0006-observability.md), la [decisión del arnés de evaluación](../adr/adr-0003-eval-harness.md), la [decisión del grafo de ejecución por streaming](../adr/adr-0010-streaming-execution-graph.md)) | Los registros de decisiones recogen la intención de diseño; no hay un registro de riesgos formal con planes de tratamiento y aceptación del riesgo residual |
...
- [Postura regulatoria](../reference/regulatory-posture.md) -- frontera de FDA/OMS/MHRA/Ley de IA de la UE
- [Ficha del modelo](../reference/model-card.md) -- Ficha de Modelo Aplicada CHAI
- [Clasificación de la Ley de IA de la UE](eu-ai-act.md) -- clasificación del nivel de riesgo de la Ley de IA de la UE
